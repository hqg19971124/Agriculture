...
def main(args):
    logger = get_logger('./shufflenet.log')
    ...
    RESUME=0
    best_acc = 0.0
    save_path = './shufflnet.pth'
    checkpoint_interval=50
    if RESUME:

        path_checkpoint = "./checkpoint_79_epoch.pth"
        ...
        for epoch in range(start_epoch,args.epochs):
            ...
            logger.info('Epoch:[{}/{}]\t train_loss={:.5f}\t val_accurate={:.3f}'.format(epoch, args.epochs,
                                                                                                       mean_loss,
                                                                                                       acc))
