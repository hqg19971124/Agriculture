...
def main():
    logger = get_logger('./ModifiedStudentModel_B_M_C_W_5_new2.log')
    logger.info('start training!')
    tb_writer = SummaryWriter('ModifiedStudentModel_B_M_C_W_5_new2')
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './ModifiedStudentModel_B_M_C_W_5_new2.pth'
    train_steps = len(train_loader)
    checkpoint_interval=20
    RESUME=0
    if RESUME:

        path_checkpoint = "./checkpoint_39_epoch_Dataset1_mul_skip_win2_0.7.pth"
        ...
        for epoch in range(start_epoch,epochs):
            ...
            if (epoch + 1) % checkpoint_interval == 0:
                checkpoint = {"model_state_dict": student_model.state_dict(),
                              ...
                              "epoch": epoch}
                path_checkpoint = "./checkpoint_{}_epoch_ModifiedStudentModel_B_M_C_W_5_new2.pth".format(epoch)
