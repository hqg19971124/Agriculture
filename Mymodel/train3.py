...
from ModifiedStudentModel_B_M_WC import *
...
def main():
    logger = get_logger('./ModifiedStudentModel_B_M_WC.log')
    logger.info('start training!')
    tb_writer = SummaryWriter('ModifiedStudentModel_B_M_WC')
    ...
    epochs = 100
    best_acc = 0.0
    save_path = './ModifiedStudentModel_B_M_WC.pth'
        ...
        for epoch in range(start_epoch,epochs):
            ...
            if (epoch + 1) % checkpoint_interval == 0:
                checkpoint = {"model_state_dict": student_model.state_dict(),
                              ...
                              "epoch": epoch}
                path_checkpoint = "./checkpoint_{}_epoch_ModifiedStudentModel_B_M_WC.pth".format(epoch)
