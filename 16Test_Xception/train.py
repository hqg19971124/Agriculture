...
def main():
    logger = get_logger('./Xception.log')
    ...
    #法1
    net=xception()
    model_weight_path = "./xception-pre.pth"
    ...
    if resume:
        ...
        for epoch in range(start_epoch,epochs):
            ...
            logger.info('Epoch:[{}/{}]\t train_loss={:.5f}\t val_accurate={:.3f}'.format(epoch, epochs, running_loss / train_steps,
                                                                         val_accurate))
